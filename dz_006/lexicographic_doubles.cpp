...
int main()
{
    ...
    // сортируем этот же массив проверенным способом через перевод в строку
    // поэтому если есть ошибки, то нужные элементы переставятся
...
// 10
// 0.1 0.001 -0.1 2.1 21 21.1 -12.02 -11.01 0 0.001
// my sort:
// -0.1 -11.01 -12.02 0 0.001 0.001 0.1 2.1 21 21.1 
// sort by "to_string":
// -0.1 -11.01 -12.02 0 0.001 0.001 0.1 2.1 21 21.1 

// 5
// 1.01 10.1 0.1 -0.1 0.01
// my sort:
// -0.1 0.01 0.1 1.01 10.1 
// sort by "to_string":
// -0.1 0.01 0.1 1.01 10.1 